...
const esteticas = [
    ...
    },
    {
        ...
        descricao: "Técnicas avançadas para auxiliar na perda de peso e definição corporal.",
...
function EsteticaSection() {
    return (
        <section>
            <h2>Estética</h2>
            <p>PROCEDIMENTOS ESTÉTICOS REALIZADOS COM SEGURANÇA, TECNOLOGIA E RESULTADOS NATURAIS</p>
